...
<body>
    ...
    <div class="mini-fit" >
    <div id="optTreeGrid" class="mini-treegrid" style="width:100%;height:100%;"  url="${ctx}/admin/merFunopt/listAll" showTreeIcon="true" treeColumn="fun_opt_nm" idField="fun_opt_id" parentField="parent_fun_opt_id" resultAsTree="false"  allowResize="true" expandOnLoad="true">
    ...
    <script type="text/javascript">
       ...
       function edit() {
        ...
        function remove() {   
        	 ...
        	 if(row){
        		//删除之前验证所选记录是否存在
     			$.post('${ctx}/admin/merFunopt/delFreCheck/' + row.fun_opt_id, function(msg){
     				if(msg){
     					$.post('${ctx}/admin/merFunopt/checkChild/' + row.fun_opt_id, function(checkMsg){
    						if(checkMsg){
    							 if (confirm("确定删除选中资源？")) {
    								 $.post('${ctx}/admin/merFunopt/delete/' + row.fun_opt_id, function(data) {
 										if(data) {
 											notify('记录删除成功!');
 											optTreeGrid.reload();
 										} else {
