...
@Controller
@RequestMapping(value = "/admin/funopt")
public class FunOptController {
 
	@RequestMapping()
	public String init() {
		return "admin/rbac/funopt";
	}
 
	@RequestMapping(value = "listAll")
	public void listAll(HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		List<SysFunOpt> allFunOpt = D.sql("Select * from T_P_FUN_OPT where user_type = ? ").many(SysFunOpt.class,SystemConstant.UserType.SYSTEM_USER);
...
//		return false;
	...
	public List<Map<String, Object>> selFunopt() {
		...
		List<SysFunOpt> list = D.sql("select * from T_P_FUN_OPT where parent_fun_opt_id is not null and user_type = ? ").many(SysFunOpt.class, SystemConstant.UserType.SYSTEM_USER) ;
