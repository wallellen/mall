...
<body>
	<div class="mini-layout" style="width: 100%; height: 100%;">
		<div title="north" region="north" class="header" bodyStyle="overflow:hidden;" height="80" showHeader="false" showSplit="false">
			...
			<div class="topNav">
				欢迎你：
				<shiro:principal type="com.wx.admin.shiro.ShiroUser" property="login_id" />
			</div>
	...
	<script type="text/javascript">
		mini.parse();
		var data = <shiro:principal type="com.wx.admin.shiro.ShiroUser" property="menuData" />
		...
		function changePwd(e) {
			mini.get("userId").setValue(<shiro:principal type="com.wx.admin.shiro.ShiroUser" property="user_id" />);
			changePwdWin.show();
		}
