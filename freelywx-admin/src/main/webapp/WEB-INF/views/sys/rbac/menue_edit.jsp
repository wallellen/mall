    ...
    <div>
	        ...
	        <table style="width:100%;">
	            ...
	            <tr>
	                ...
	                <td style="width:150px;">
	                	<input name="fun_opt_id" style="width:150px;" class="mini-treeselect" url="${ctx}/sys/funopt/listAll" multiSelect="false"  valueFromSelect="false" required="true"
					    ...
					    />
	                	<%-- <input name="fun_opt_id" class="mini-combobox" url="${ctx}/sys/funopt/selFunopt"  required="true" textField="text" valueField="id"  /> --%>   
	                </td>
	            </tr>
	            <tr>
	                <td style="width:80px;">菜单排序：</td>
	                <td style="width:150px;">
	                	<input name="sort" class="mini-textbox" vtype="int"  required="true" />
	                </td>
	            </tr>
	             <tr>
    ...
    <script type="text/javascript">
		...
		function SetData(data) {
			if (data.action == "edit") {
				...
				$.ajax({
					url : "${ctx }/sys/menue/getMenueById/" + data.menue_id,
					cache : false,
					success : function(text) {
