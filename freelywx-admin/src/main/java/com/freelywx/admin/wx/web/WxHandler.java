...
//import com.freelywx.admin.wx.msg.OutMsgXmlBuilder;
//import com.freelywx.admin.wx.msg.in.InImageMsg;
//import com.freelywx.admin.wx.msg.in.InLinkMsg;
//import com.freelywx.admin.wx.msg.in.InLocationMsg;
//import com.freelywx.admin.wx.msg.in.InMsg;
//import com.freelywx.admin.wx.msg.in.InTextMsg;
//import com.freelywx.admin.wx.msg.in.InVideoMsg;
//import com.freelywx.admin.wx.msg.in.InVoiceMsg;
//import com.freelywx.admin.wx.msg.in.event.InFollowEvent;
//import com.freelywx.admin.wx.msg.in.event.InLocationEvent;
//import com.freelywx.admin.wx.msg.in.event.InMenuEvent;
//import com.freelywx.admin.wx.msg.in.event.InQrCodeEvent;
//import com.freelywx.admin.wx.msg.in.speech_recognition.InSpeechRecognitionResults;
//import com.freelywx.admin.wx.msg.out.OutImageMsg;
...
//import com.freelywx.admin.wx.msg.out.OutVoiceMsg;
...
//		
//		//微信帐号表
//		TPMerchantWx tpm=D.sql("select * from t_p_merchant_wx where original_id=?").oneOrNull(TPMerchantWx.class, inFollowEvent.getToUserName());
//		
//		//得到微信粉丝的信息
//		WxMember member = WeixinUtil.getUser(inFollowEvent.getFromUserName(), AccessTokenApi.getAccessToken(tpm.getApp_id(), tpm.getApp_secret()).getAccessToken());
//		
//		//微信关注粉丝表
...
//				tm.setLast_update_time(new Date());
//				tm.setMember_city(member.getCity());
//				tm.setMember_country(member.getCountry());
//				tm.setMember_img(member.getHeadimgurl());
//				tm.setMember_name(member.getNickname());
//				tm.setMember_province(member.getProvince());
//				tm.setMember_sex(member.getSex());
//				tm.setOpen_id(inFollowEvent.getFromUserName());
//				tm.setUid(tpm.getUser_id());
...
//			}
//			//从关注表中查出关注时回复的信息
//			TPubAttention tpa=D.sql("select * from t_pub_attention where UID=?").oneOrNull(TPubAttention.class, tpm.getUser_id());
//			if(tpa!=null&&tpa.getIs_key().equals(SystemConstant.AttentionIsKey.YES)&& StringUtils.isNotEmpty(tpa.getKeyword()))	//如果回复的是关键字的信息，则需去查关键字
//			{
...
//					return str;
//				}
//			}else if(tpa!=null&&tpa.getContent()!=null&&!"".equals(tpa.getContent())){
//				OutTextMsg outMsg = new OutTextMsg(inFollowEvent);
//				outMsg.setContent(tpa.getContent());
