...
public class FunOptController {
	...
	public void listAll(HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		List<TpFunOpt> allFunOpt = D.sql("Select * from T_P_FUN_OPT where user_type = ? ").many(TpFunOpt.class,SystemConstant.UserType.SYSTEM_USER);
...
//		return false;
	...
	public List<Map<String, Object>> selFunopt() {
		...
		List<TpFunOpt> list = D.sql("select * from T_P_FUN_OPT where parent_fun_opt_id is not null and user_type = ? ").many(TpFunOpt.class, SystemConstant.UserType.SYSTEM_USER) ;
