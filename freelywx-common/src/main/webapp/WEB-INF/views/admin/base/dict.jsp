...
<body>
    ...
    <div id="dictDataGrid" class="mini-datagrid" style="width:100%;height:100%;"  allowResize="true"
        url="${ctx}/admin/dict/list"  idField="dict_id" multiSelect="true" pageSize="100">
       ...
       function edit() {
        ...
        function remove() {   
	       	 ...
	       	 if(row){
	       		if (confirm("确定删除字典？")) {
	       		//删除选中记录
					$.post("${ctx}/admin/dict/delete/"+ row.dict_id,function(result) {
						if (result) {
							notify('删除成功');
							grid.reload();
						} else {
        ...
        function getDetail(){
        	var row = grid.getSelected();
	       	 if(row){
				window.location.href = "${ctx}/admin/dictDetail?dictId="+row.dict_id;	       				
	       	 }else {
	       		 notify("请选中一条记录");
	         }
        }
