...
<body>
	...
	<div class="mini-fit" >
	<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" allowResize="true" url="${ctx}/sys/sysLog/list" idField="log_id" multiSelect="true">
	...
	<form id="excelForm" action="${ctx}/sys/sysLog/exportSysLog" method="post" target="excelIFrame"></form>
	...
	<script type="text/javascript">
		...
		function ClearExcel() {
			if (confirm("确定清空日志？")) {
				$.post('${ctx}/sys/sysLog/delete/', function(data) {
					if (data) {
						notify('日志删除成功!');
						grid.reload();
					} else {
		...
		function ExportExcel() {
			if (confirm("确定导出日志？")) {
				var url = '${ctx}/sys/sysLog/exportSysLog';
