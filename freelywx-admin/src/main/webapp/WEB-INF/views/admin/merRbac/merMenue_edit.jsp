    ...
    <div>
	        ...
	        <table style="width:100%;">
	            ...
	            <tr>
	                ...
	                <td style="width:150px;">
	                	<input name="fun_opt_id" style="width:150px;" class="mini-treeselect" url="${ctx}/admin/merFunopt/listAll" multiSelect="false"  valueFromSelect="false" required="true"
    ...
    <script type="text/javascript">
		...
		function SetData(data) {
			if (data.action == "edit") {
				...
				$.ajax({
					url : "${ctx }/admin/merMenue/getMenueById/" + data.menue_id,
					cache : false,
					success : function(text) {
